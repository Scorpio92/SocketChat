package ru.scorpio92.socketchat.data.repository.network;
...
import ru.scorpio92.socketchat.data.model.response.AuthServerDataResponse;
import ru.scorpio92.socketchat.data.repository.network.base.IAuthRepo;
import ru.scorpio92.socketchat.data.repository.network.core.RetrofitNetworkRepository;
import ru.scorpio92.socketchat.exception.auth.IncorrectPairException;
import ru.scorpio92.socketchat.exception.general.WtfException;
import ru.scorpio92.socketchat.exception.reg.InvaidLoginException;
import ru.scorpio92.socketchat.exception.reg.InvaidNicknameException;
import ru.scorpio92.socketchat.exception.reg.InvaidPasswordException;
import ru.scorpio92.socketchat.exception.reg.LoginExistsException;
import ru.scorpio92.socketchat.exception.reg.NicknameExistsException;
