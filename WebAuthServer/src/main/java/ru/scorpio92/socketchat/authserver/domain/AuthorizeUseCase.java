...
import ru.scorpio92.socketchat.authserver.data.db.AccountsTable;
import ru.scorpio92.socketchat.authserver.data.db.AuthInfoTable;
import ru.scorpio92.socketchat.authserver.data.model.AuthInfo;
import ru.scorpio92.socketchat.authserver.data.model.message.base.BaseMessage;
import ru.scorpio92.socketchat.authserver.data.model.message.base.ErrorCode;
import ru.scorpio92.socketchat.authserver.data.model.message.base.ErrorMessage;
import ru.scorpio92.socketchat.authserver.data.model.message.base.SuccessMessage;
import ru.scorpio92.socketchat.authserver.data.model.message.request.AuthServerDataRequest;
import ru.scorpio92.socketchat.authserver.data.model.message.request.RegisterServerDataRequest;
import ru.scorpio92.socketchat.authserver.data.model.message.response.AuthServerDataResponse;
